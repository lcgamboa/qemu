...
REG32(C3_WIFI_NEXT_RX_DSCR, 0x08c);
REG32(C3_WIFI_LAST_RX_DSCR, 0x090);
...
REG32(C3_WIFI_TX_CONFIG, 0xd04);
REG32(C3_WIFI_TX_CLR, 0xcac);
REG32(C3_WIFI_TX_DURATION, 0x318);
REG32(C3_WIFI_OFFSET_REG, 0xc64);
